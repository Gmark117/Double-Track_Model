...
addpath('dataset/')
addpath('tyre_lib/')
addpath('tyre_lib/magic_formula/')
addpath('tyre_lib/FX/')
addpath('tyre_lib/FY/')
addpath('tyre_lib/MZ/')
...
%% Raw Data Plotting
plot_data_raw(data_LAT, cut_start_LAT, cut_end_LAT, 'Lateral Raw Data')
plot_data_raw(data_LONG, cut_start_LONG, cut_end_LONG, 'Longitudinal Raw Data')
