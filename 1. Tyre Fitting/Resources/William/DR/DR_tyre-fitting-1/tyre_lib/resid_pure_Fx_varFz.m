function res = resid_pure_Fx(P,FX,KAPPA,GAMMA,FZ,tyre_data)
    ...
    tmp_tyre_data.pDx3 = P(2);
    tmp_tyre_data.pEx2 = P(3);
    tmp_tyre_data.pEx3 = P(4);
    tmp_tyre_data.pHx2 = P(5);
    tmp_tyre_data.pKx2 = P(6);
    tmp_tyre_data.pKx3 = P(7);
    tmp_tyre_data.pVx2 = P(8);
